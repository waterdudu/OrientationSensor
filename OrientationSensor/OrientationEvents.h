...
class COrientationEvents :
	public ISensorEvents
{
public:
	COrientationEvents(SimpleOrientationSensor * pSimpleOrientationSensor);
	~COrientationEvents(void);
...
private:
	SimpleOrientationSensor *m_pSimpleOrientationSensor;
    long m_cRef;
};
